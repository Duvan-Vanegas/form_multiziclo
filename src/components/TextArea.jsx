...
const TextArea = React.forwardRef(({ label, error, className = '', id, ...props }, ref) => {
    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="relative max-w-md mx-auto">
        <textarea
          id={inputId}
          ref={ref}
          className={`wizard-input text-center min-h-[120px] resize-y outline-none ring-0 focus:ring-0 ${error ? 'border-red-400 focus:border-red-500' : ''}`}
          {...props}
        />
      </div>
      {error && (
